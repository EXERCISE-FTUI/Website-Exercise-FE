...
function ExTicle() {
  const exticleAllRef: RefObject<HTMLDivElement> = useRef(null);
  const scrollToExticleAll = () => {
    if (exticleAllRef.current) {
      exticleAllRef.current.scrollIntoView({ behavior: 'smooth' });
    }
  };
  return (
        ...
        <div className="bg-[#527182] flex flex-col rounded-xl shadow-inner shadow-black">
          ...
          <div className="mr-[15%] flex flex-row mt-[10px]">
            ...
            <div className=' bg-[#1A323E] shadow-black shadow-sm h-[35px] md:h-[65px] md:rounded-4xl rounded-3xl w-[130px] md:w-[210px] flex flex-row p-[8px] md:p-[10px] mx-[1%] hover:bg-[#527182] transition-colors hover:cursor-pointer'>
              <div className='flex flex-col' onClick={scrollToExticleAll}>
