  ...
  return (
    ...
    >
      <div className="h-[750px] md:h-[1000px] lg:h-[1292px] w-[1600px] relative ">
        <div className="hexa justify-center top-[150px] md:top-[7%] lg:top-[140px] left-[-64px] md:left-[-15%] lg:left-[-170px] absolute z-0"></div>
        <div className="hexb justify-center top-[282px] md:top-[38%] lg:top-[440px] right-[-81px] md:right-[-15%] lg:right-[-140px] absolute z-0"></div>
        <div className="flex flex-col absolute top-[190px] md:top-[12%] lg:top-[335px] left-[16px] md:left-[3%] lg:left-[35px]">
          <div className="bg-white leading-none w-fit absolute z-50">
            <h1 className="text-exer-charcoal leading-none font-inter font-black text-[30px] md:text-[60px] lg:text-[100px]">
              VISI
            </h1>
        ...
        <div className="flex flex-col absolute top-[295px] md:top-[43%] lg:top-[535px] right-40 md:right-[300px] lg:right-[700px]">
          <div className="bg-white leading-none w-fit absolute z-50 lg:right-[-600px]">
